...
export default function Home() {
  return (
    <div className="h-screen grid grid-cols-5 grid-rows-8 bg-app-bg text-app-fg overflow-hidden relative">
      ...
      <div className="col-start-2 col-span-3 row-start-7 flex">
        <EmailBuyButton />
      </div>
    </div>
  );
