  ...
  return (
    <div ref={containerRef} className="w-full">
      {!open ? (
        <button
          disabled={disabled}
          className="h-10 inline-flex items-center justify-start rounded-md text-[#dadada] text-lg cursor-pointer underline disabled:opacity-60 hover:text-green-600"
